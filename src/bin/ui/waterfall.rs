...
impl WaterfallRenderer {
    ...
    pub fn prepare(
        ...
        for chunk in chunks {
            ...
            let y_start = now.duration_since(chunk.end_time).as_secs_f32();
            let y_end = now.duration_since(chunk.start_time).as_secs_f32();
            ...
            let x_left = (chunk.center_frequency - 0.5 * chunk.width) as f32;
